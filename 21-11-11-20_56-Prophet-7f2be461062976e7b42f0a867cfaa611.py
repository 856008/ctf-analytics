...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/847755206731939/s?orderByKey=metrics.%60val_mae%60&orderByAsc=true)
# MAGIC - Navigate to the parent notebook [here](#notebook/847755206731938) (If you launched the AutoML experiment using the Experiments UI, this link isn't very useful.)
...
mlflow.set_experiment("/Users/856008@corpaa.aa.com/databricks_automl/TOTAL_GIFT_AMOUNT_result_obula_1_csv-2021_11_11-14_54")

target_col = "TOTAL_GIFT_AMOUNT"
time_col = "CLOSEDATE"
unit = "D"
...
input_data_path = input_client.download_artifacts("7baaaf2e48414848a2ff14e7850920a4", "data", input_temp_dir)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/847755206731939/s?orderByKey=metrics.%60val_mae%60&orderByAsc=true)
...
def prophet_training(history_pd):
  ...
  def prophet_fit_predict(params):
    ...
    return {"loss": metrics["mae"], "metrics": metrics, "status": STATUS_OK}
  ...
  best_result = fmin(
    ...
    trials=trials,
    timeout=262,
    rstate = np.random.RandomState(360160249))
