...
# MAGIC This is an auto-generated notebook. To reproduce these results, attach this notebook to the **ML_Cluster** cluster and rerun it.
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/847755206732316/s?orderByKey=metrics.%60val_rmse%60&orderByAsc=true)
# MAGIC - Navigate to the parent notebook [here](#notebook/847755206732315) (If you launched the AutoML experiment using the Experiments UI, this link isn't very useful.)
...
mlflow.set_experiment("/Users/856008@corpaa.aa.com/databricks_automl/TOTAL_NUMBER_OF_GIFTS_result_obula_count_1_csv-2021_11_11-15_13")

target_col = "TOTAL_NUMBER_OF_GIFTS"
time_col = "CLOSEDATE"
unit = "D"
...
input_data_path = input_client.download_artifacts("c4dc1f7b91364047884e052e77cc201d", "data", input_temp_dir)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/847755206732316/s?orderByKey=metrics.%60val_rmse%60&orderByAsc=true)
...
def prophet_training(history_pd):
  ...
  def prophet_fit_predict(params):
    ...
    return {"loss": metrics["rmse"], "metrics": metrics, "status": STATUS_OK}
  ...
  best_result = fmin(
    ...
    trials=trials,
    timeout=273,
    rstate = np.random.RandomState(123216530))
